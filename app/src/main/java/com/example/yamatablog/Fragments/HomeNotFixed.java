 ...
 * Use the {@link HomeNotFixed#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HomeNotFixed extends Fragment {
     ...
     * @return A new instance of fragment HomeNotFixed.
     */
    // TODO: Rename and change types and number of parameters
    public static HomeNotFixed newInstance(String param1, String param2) {
        HomeNotFixed fragment = new HomeNotFixed();
        ...
        PostRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot postsnap : dataSnapshot.getChildren()){
                    ...
                    if (post.getPostStatus().equals("notFixed"))
                        postList.add(post);
